#!/usr/bin/env python3
"""
Test filtering empty images - FIXED VERSION with server-side filter
"""
...
print("="*60)
print("Testing filter empty images solution (FIXED)")
print("="*60)
...
# Filter out empty images - SERVER-SIDE approach
print("\n🔍 Filtering out empty images (server-side)...")
# Use map to add a property indicating if image has bands, then filter
...
ee_col_year_median_filtered = ee_col_with_flag.filter(ee.Filter.eq('has_bands', 1))
