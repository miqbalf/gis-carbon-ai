...
async def generate_gee_tile(project_id: str, layer: str, z: int, x: int, y: int, 
    ...
    try:
        ...
        # Try to get the actual GEE tile URL from registered catalogs
        catalog_keys = redis_client.keys("catalog:*")
            ...
            if catalog_data:
                ...
                if layer in layers_info:
                    ...
                    if bbox_coords and len(bbox_coords) > 0:
                        ...
                        # Check if tile is within bbox
                        if not is_tile_in_bbox(x, y, z, bbox):
                            logger.info(f"Tile {z}/{x}/{y} is outside analysis bbox, returning no-data tile")
                            # Return a light gray tile instead of transparent to avoid ORB blocking
                            return create_colored_tile(240, 240, 240, 255)  # Light gray no-data tile
        ...
        if layer == "ndvi":
            return create_colored_tile(0, 150, 0, 255), "image/png"  # Green for NDVI
        elif layer == "evi":
            return create_colored_tile(0, 100, 0, 255), "image/png"  # Dark green for EVI
        elif layer == "ndwi":
            return create_colored_tile(0, 0, 150, 255), "image/png"  # Blue for NDWI
        elif layer == "true_color":
            return create_colored_tile(100, 100, 100, 255), "image/png"  # Gray for true color
        elif layer == "false_color":
            return create_colored_tile(150, 100, 50, 255), "image/png"  # Brown for false color
        elif layer == "FCD1_1":
            return create_colored_tile(0, 100, 0, 255), "image/png"  # Green
        elif layer == "FCD2_1":
            return create_colored_tile(0, 80, 0, 255), "image/png"   # Dark green
        elif layer == "image_mosaick":
            return create_colored_tile(0, 0, 255, 255), "image/png"  # Blue
        elif layer == "avi_image":
            return create_colored_tile(255, 0, 0, 255), "image/png"  # Red
        else:
            # Default gray tile
...
def generate_wmts_capabilities_improved():
    ...
    try:
        ...
        <Layer>
            ...
            <ows:Identifier>sentinel_analysis_20251023_061319_true_color</ows:Identifier>
            <ows:WGS84BoundingBox>
            ...
            <ResourceURL format="image/png" 
                resourceType="tile" 
                template="http://localhost:8001/wmts?service=WMTS&amp;request=GetTile&amp;version=1.0.0&amp;layer=sentinel_analysis_20251023_061319_true_color&amp;tilematrixset=GoogleMapsCompatible&amp;tilematrix={TileMatrix}&amp;tilerow={TileRow}&amp;tilecol={TileCol}&amp;format=image/png"/>
        </Layer>
        <Layer>
            <ows:Title>GEE Improved WMTS False Color</ows:Title>
            <ows:Identifier>sentinel_analysis_20251023_061319_false_color</ows:Identifier>
            <ows:WGS84BoundingBox>
                <ows:LowerCorner>109.5 -1.5</ows:LowerCorner>
                <ows:UpperCorner>110.5 -0.5</ows:UpperCorner>
            </ows:WGS84BoundingBox>
            ...
            <ResourceURL format="image/png" 
                resourceType="tile" 
                template="http://localhost:8001/wmts?service=WMTS&amp;request=GetTile&amp;version=1.0.0&amp;layer=sentinel_analysis_20251023_061319_false_color&amp;tilematrixset=GoogleMapsCompatible&amp;tilematrix={TileMatrix}&amp;tilerow={TileRow}&amp;tilecol={TileCol}&amp;format=image/png"/>
        </Layer>
        <Layer>
            <ows:Title>GEE Improved WMTS NDVI</ows:Title>
            <ows:Identifier>sentinel_analysis_20251023_061319_ndvi</ows:Identifier>
            <ows:WGS84BoundingBox>
                <ows:LowerCorner>109.5 -1.5</ows:LowerCorner>
                <ows:UpperCorner>110.5 -0.5</ows:UpperCorner>
            </ows:WGS84BoundingBox>
            ...
            <ResourceURL format="image/png" 
                resourceType="tile" 
                template="http://localhost:8001/wmts?service=WMTS&amp;request=GetTile&amp;version=1.0.0&amp;layer=sentinel_analysis_20251023_061319_ndvi&amp;tilematrixset=GoogleMapsCompatible&amp;tilematrix={TileMatrix}&amp;tilerow={TileRow}&amp;tilecol={TileCol}&amp;format=image/png"/>
        </Layer>"""
